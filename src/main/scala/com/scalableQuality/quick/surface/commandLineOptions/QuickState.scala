...
import com.scalableQuality.quick.core.fileProcessingPhase.{MatchRows, RowsProcessingPhase, ValidateAndMatchRows}
...
object QuickState {
  ...
  def validateAndMatchRows: RowsProcessingPhaseConstructor = ValidateAndMatchRows(_,_,_,_,_)
